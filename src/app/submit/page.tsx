...
export default function SubmitPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.short_description.length > 140) {
      setError("Short description must be 140 characters or less.");
      setIsSubmitting(false);
      return;
    }

    // Simulate submission (in production, this would POST to Supabase)
    try {
